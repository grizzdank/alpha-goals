...
export function CurrentSprint() {
  return (
    <div className="glass rounded-2xl p-5 md:p-8 mb-6">
      <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-4 md:mb-6">
        ...
        <div className="h-10 w-10 rounded-full bg-relationships/20 flex items-center justify-center mt-4 md:mt-0 self-start">
